...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <span class="brand-text font-weight-light">Online Test Portal</span>
    </a>
...
<!-- ChartJS -->
<script src="{{ url('public/assets/plugins/plugins/chart.js/Chart.min.js') }}"></script>
<!-- Sparkline -->
<script src="{{ url('public/assets/plugins/plugins/sparklines/sparkline.js') }}"></script>
<!-- JQVMap -->
...
<!-- AdminLTE App -->
<script src="{{ url('public/assets/plugins/dist/js/adminlte.js') }}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ url('public/assets/plugins/dist/js/pages/dashboard.js') }}"></script>
